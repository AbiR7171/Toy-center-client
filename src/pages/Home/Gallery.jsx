    ...
    return (
       <div>
        <h1 className="text-7xl text-center mt-5 mb-10">Our Gallery</h1>
         <div className='container mx-auto mt-10 grid grid-cols-3 gap-2'>
            <div>
                <img src={pic1} className='rounded h-72 hover:scale-125' alt="" />
            </div>
            <div>
                <img src={pic2} className='rounded h-72 hover:scale-125 duration-75' alt="" />
            </div>
            <div>
                <img src={pic3} className='rounded h-72 hover:scale-125 duration-75 ' alt="" />
            </div>
            <div>
                <img src={pic4} className='rounded h-72  hover:scale-125 duration-75' alt="" />
            </div>
            <div>
                <img src={pic5} className='rounded h-72  hover:scale-125 duration-75' alt="" />
            </div>
            <div>
                <img src={pic6} className='rounded h-72  hover:scale-125 duration-75' alt="" />
            </div>
        </div>
       </div>
    );
